...
public class AboutFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("哈哈哈哈" + mIntroduction.getLayoutResource());
        ...
        mVersion.setSummary("1.0");
    }

    @Override
    public boolean onPreferenceClick(Preference preference) {
        if (mVersion == preference) {
            new AlertDialog.Builder(getActivity()).setTitle("随心记的完成离不开开源项目的支持，向以下致谢：")
            ...
            new AlertDialog.Builder(getActivity()).setTitle("点赞")
                    ...
                    .setNegativeButton("复制", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            copyToClipboard(getView(), getActivity().getResources().getString(R.string.app_html));
                        }
                    })
            ...
            copyToClipboard(getView(), mBlog.getSummary().toString());
