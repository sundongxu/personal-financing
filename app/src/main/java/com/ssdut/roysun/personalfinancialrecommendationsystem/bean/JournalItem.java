...
public class JournalItem {
    ...
    public static String sTraffic[] = new String[]{TRAFFIC_TEXI, TRAFFIC_BUS, TRAFFIC_SUBWAY, TRAFFIC_TRAIN, TRAFFIC_SHIP, TRAFFIC_PLANE, TRAFFIC_PETROL, TRAFFIC_PARKING, TRAFFIC_OTHERS};
    public static String sShopping[] = new String[]{SHOPPING_CLOTHES, SHOPPING_NECESSICITY, SHOPPING_DIGITAL, SHOPPING_COSMETICS, SHOPPING_ELECTRONICS, SHOPPING_FURNITURE, SHOPPING_CIGARETTES_WINE, SHOPPING_OTHERS};
    public static String sEntertainment[] = new String[]{ENTERTAINMENT_KTV, ENTERTAINMENT_MOVIE, ENTERTAINMENT_ONLINE_GAME, ENTERTAINMENT_TV, ENTERTAINMENT_FITNESS, ENTERTAINMENT_BATHING, ENTERTAINMENT_TRAVEL, ENTERTAINMENT_OTHERS};
    public static String sMeditationEducation[] = new String[]{MEDITATION_EDUCATION_HOSPITAL, MEDITATION_EDUCATION_TRAINNING, MEDITATION_EDUCATION_TEXTBOOK, MEDITATION_EDUCATION_TUTOR, MEDITATION_EDUCATION_OTHERS};
    public static String sDailyExpense[] = new String[]{DAILY_EXPENSE_WATER_ELECTRICITY_GASOLINE, DAILY_EXPENSE_CALL, DAILY_EXPENSE_BEAUTY, DAILY_EXPENSE_HOUSE_LOAN, DAILY_EXPENSE_ACCOMMODATION, DAILY_EXPENSE_PROPERTY_MANAGEMENT, DAILY_EXPENSE_OTHERS};
    public static String sInvestment[] = new String[]{INVESTMENT_STOCK_FUTURES, INVESTMENT_GOLD, INVESTMENT_ANTIQUE, INVESTMENT_LOAN, INVESTMENT_INSURANCE, INVESTMENT_OTHERS};
